...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 28, 2024 at 10:25 PM
...
INSERT INTO `menu_item` (`id`, `url`, `permissionId`, `name`) VALUES
(1, 'pages-add-user.php', 1, 'Add User'),
(2, 'pages-add-drug.php', 2, 'Add Drug'),
(3, 'pages-add-Text.php', 3, 'Analyze Text'),
(4, 'pages-drug-list.php', 4, 'Drug List'),
(5, 'pages-update-drug.php', 5, 'Drug Update');
...
INSERT INTO `text` (`id`, `text`, `analyzed`, `userId`) VALUES
(1, 'ss ss', 'ss: 2, Spaces: 1', 5),
(2, 'xx xx', 'xx: 2, Spaces: 1', 5),
(3, 'sdsd', 'sdsd: 1, Spaces: 0', 5),
(4, 'sds', 'sds: 1, Spaces: 0', 5),
(5, 'نن تت', 'نن: 1, تت: 1, Spaces: 1', 5);
...
(7, 'abc', 'abc', '$2y$10$T4KGDjt5zrD5k3pnYzYe1OHJB9YJT46CtOV602wc0AVXFCj/SU3Sa', 2);
